...
namespace OutfitGenerator.Util
{
    public static class FileSaver
    {
        ...
        public static string Save(string directoryPath, string content, string fileNamePrefix = "outfitGenerator_", string extension = ".txt")
        {
        ...
        /// <returns>File path.</returns>
        public static string SaveImage(string directoryPath, Image<Rgba32> image, string fileNamePrefix = "merged_")
        {
